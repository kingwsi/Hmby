<template>
    <a-drawer v-model:open="drawerVisible" :title="`${mediaDetail.SortName} - (ID:${mediaDetail.Id})`"
        @close="drawerClose" placement="right" :width="800" :maskClosable="false" :destroyOnClose="true">
        <a-spin :spinning="loading" tip="加载中...">
            ...
            <a-descriptions :column="1" bordered size="small" v-if="videoStreamMain">
                ...
                <a-descriptions-item v-if="mediaDetail.mediaInfo" label="源文件">
                    ...
                    <a-divider type="vertical" /> {{ mediaDetail.mediaInfo.timeCost }}
